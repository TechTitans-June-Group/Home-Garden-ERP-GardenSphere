...
export const initialInventory = [
  {
    ...
    status: 'Available',
    supplierId: 'sup1',
    location: 'Seed cabinet A',
    notes: 'Cherry and beefsteak mix for the next planting cycle.',
  ...
  },
  {
    ...
    location: 'Seed cabinet A',
    notes: '',
    image: '/inventory/basil.png',
  },
  {
    id: 'inv3',
    item: 'Organic NPK 10-10-10',
    ...
    notes: '',
    image: '/inventory/npk.png',
  },
  {
    id: 'inv4',
    item: 'Garden Soil Mix',
    category: 'Soil',
    stock: 22,
    damaged: 0,
    minStock: 10,
  ...
  },
  {
    ...
    supplierId: 'sup2',
    location: 'Compost yard',
    notes: 'Reorder before tomato transplant week.',
    image: '/inventory/compost.png',
  },
  {
    id: 'inv6',
    item: 'Neem Oil',
  ...
  },
  {
    ...
    status: 'Available',
    supplierId: 'sup3',
    location: 'Irrigation rack',
    notes: '',
    image: '/inventory/drip.png',
  },
  {
    id: 'inv9',
    item: 'Nursery Pots 8 inch',
    category: 'Plant Containers',
    stock: 120,
    damaged: 8,
    minStock: 50,
    unit: 'Pcs',
  ...
  },
  {
    ...
    supplierId: 'sup3',
    location: 'Tool shed',
    notes: 'Used for staking tomatoes and beans.',
    image: '/inventory/twine.png',
  },
];

export const initialSuppliers = [
  { id: 'sup1', name: 'GreenSeed Lanka', contact: '0712223344', email: 'sales@greenseed.lk', category: 'Seeds', address: 'Peradeniya Road, Kandy', status: 'Active' },
  { id: 'sup2', name: 'Eco Compost Co.', contact: '0778899001', email: 'hello@ecocompost.lk', category: 'Compost', address: 'Gampola', status: 'Active' },
  { id: 'sup3', name: 'Farm Tools Kandy', contact: '0812221111', email: 'tools@ftk.lk', category: 'Gardening Tools', address: 'Katugastota', status: 'Active' },
  { id: 'sup4', name: 'Lanka Agro Inputs', contact: '0112558899', email: 'orders@lankaagro.lk', category: 'Fertilizers', address: 'Colombo 10', status: 'Active' },
];

export const initialPurchases = [
  { id: 'pur1', itemId: 'inv1', item: 'Tomato Seeds', supplierId: 'sup1', supplier: 'GreenSeed Lanka', date: '2026-08-04', quantity: 200, unitCost: 150, amount: 30000, status: 'Received' },
  { id: 'pur2', itemId: 'inv5', item: 'Organic Compost', supplierId: 'sup2', supplier: 'Eco Compost Co.', date: '2026-08-11', quantity: 6, unitCost: 800, amount: 4800, status: 'Received' },
  { id: 'pur3', itemId: 'inv8', item: 'Drip Irrigation Kit', supplierId: 'sup3', supplier: 'Farm Tools Kandy', date: '2026-08-17', quantity: 2, unitCost: 3200, amount: 6400, status: 'Ordered' },
  { id: 'pur4', itemId: 'inv10', item: 'Garden Twine', supplierId: 'sup3', supplier: 'Farm Tools Kandy', date: '2026-08-19', quantity: 12, unitCost: 180, amount: 2160, status: 'Ordered' },
];

export const initialStock = [
  { id: 'st1', itemId: 'inv1', item: 'Tomato Seeds', type: 'Stock In', quantity: 200, date: '2026-08-04', note: 'Purchase received from GreenSeed Lanka', actorName: 'Inventory Manager' },
  { id: 'st2', itemId: 'inv5', item: 'Organic Compost', type: 'Stock Out', quantity: 4, date: '2026-08-15', note: 'Used in Bed B2', actorName: 'Lead Gardener' },
  { id: 'st3', itemId: 'inv6', item: 'Neem Oil', type: 'Stock Out', quantity: 1, date: '2026-08-16', note: 'Aphid treatment', actorName: 'Lead Gardener' },
  { id: 'st4', itemId: 'inv3', item: 'Organic NPK 10-10-10', type: 'Damaged', quantity: 2, date: '2026-08-12', note: 'Torn bags after rain', actorName: 'Inventory Manager' },
  { id: 'st5', itemId: 'inv9', item: 'Nursery Pots 8 inch', type: 'Damaged', quantity: 8, date: '2026-08-14', note: 'Cracked in transit', actorName: 'Inventory Manager' },
];
