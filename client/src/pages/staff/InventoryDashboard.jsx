  ...
  return (
    <PortalDashboard
      ...
      modules={[
        ...
        { title: 'Purchases', description: 'Supplier restocks and customer shop orders linked to harvest sales.', to: '/staff/purchases', icon: Package, tint: 'bg-amber-100 text-amber-700' },
